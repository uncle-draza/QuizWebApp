...
namespace QuizzWebApp.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,quizzQuestion,quizzAnswer")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,quizzQuestion,quizzAnswer")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
